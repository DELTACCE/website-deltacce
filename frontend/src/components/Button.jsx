...
export default function Button({ children, to, href, onClick, variant = 'primary', className = '', ...props }) {
  const baseStyle = "inline-flex items-center justify-center font-heading text-xs md:text-sm font-bold tracking-wider uppercase px-6 py-3.5 transition-all duration-300 border-2 select-none active:scale-[0.98]";
