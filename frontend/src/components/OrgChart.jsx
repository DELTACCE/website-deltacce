...
export default function OrgChart() {
  return (
    <div className="relative font-heading border border-indigo/10 p-8 md:p-12 bg-paper/30 select-none overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-4 max-w-3xl mx-auto text-center">
        ...
        <div className="relative z-10 border border-indigo/25 bg-paper px-6 py-3 min-w-[220px] shadow-sm">
        ...
        <div className="w-[1px] h-8 bg-indigo/20 relative">
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2 h-2 bg-signal"></div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full pt-4">
          ...
          {/* Tech */}
          <div className="border border-indigo/15 bg-paper/50 py-3 px-4 flex flex-col justify-center relative">
            ...
            <span className="text-xs font-extrabold text-indigo uppercase">Technical Team</span>
          </div>
          ...
          <div className="border border-indigo/15 bg-paper/50 py-3 px-4 flex flex-col justify-center relative">
            ...
            <span className="text-xs font-extrabold text-indigo uppercase">Media Leads</span>
          </div>
          ...
          <div className="border border-indigo/15 bg-paper/50 py-3 px-4 flex flex-col justify-center relative">
            ...
            <span className="text-xs font-extrabold text-indigo uppercase">Content Writers</span>
          </div>
          ...
          <div className="border border-indigo/15 bg-paper/50 py-3 px-4 flex flex-col justify-center relative">
            ...
            <span className="text-xs font-extrabold text-indigo uppercase">Event Coord.</span>
          </div>
        ...
        <div className="w-[1px] h-6 bg-indigo/10 relative">
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 bg-teal"></div>
        </div>

        {/* Level 4: Members Network */}
        <div className="border border-dashed border-indigo/30 bg-paper/10 px-8 py-3">
